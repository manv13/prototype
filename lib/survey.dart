          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("${index + 1}).${questions[index]["ques"]}"),
                  questions[index]["a"] == ""
                      ? Container()
                      : Row(
                          children: [
                            ...
                            RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                  TextSpan(text: "\t${questions[index]["a"]}")
                                ]))
                          ],
                        ),
                  questions[index]["b"] == ""
                          ...
                          children: [
                            ...
                            RichText(
                                text: TextSpan(
                                    ...
                                    style: TextStyle(color: Colors.black),
                                    children: [
                                  TextSpan(text: "\t${questions[index]["b"]}")
                                ]))
                          ],
                        ),
                  questions[index]["c"] == ""
                          ...
                          children: [
                            ...
                            RichText(
                                text: TextSpan(
                                    ...
                                    style: TextStyle(color: Colors.black),
                                    children: [
                                  TextSpan(text: "\t${questions[index]["c"]}")
                                ]))
                          ],
                        ),
                  questions[index]["d"] == ""
                          ...
                          children: [
                            ...
                            RichText(
                                text: TextSpan(
                                    ...
                                    style: TextStyle(color: Colors.black),
                                    children: [
                                  TextSpan(text: "\t${questions[index]["d"]}")
                                ]))
                          ],
                        ),
                  Divider(
